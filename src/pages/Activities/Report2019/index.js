    ...
    return (
        <div className='Report2019-js'>
            <div className='container'>
                <h1>REPORT ON THE ACTIVITIES OF THE ASSOCIATION OF DISABLED PEOPLE FOR 2019</h1>
            </div>
            <div className='Report2019 container'>
                <SideBar />
                <div className='content'>
                    <CrContent mediatype="image" src="https://www.popliklar.uz/otchet2019/otchet2019.jpg" title="According to the Charter, the main goals and objectives of the Association of Disabled People of Uzbekistan are:" caption="The main goal of the Association of Disabled People is — to create an inclusive society (a society where all citizens have equal opportunities for the development and realization of their potential).
